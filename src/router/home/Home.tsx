    ...
    <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white p-8 flex flex-wrap justify-center gap-8">
      {data.map((phone: IPhone) => (
        ...
        >
          ...
          <p className="text-gray-300 text-sm z-10 relative flex items-center"><FaMobileAlt className="mr-2" /> Model: <span className="font-semibold text-white ml-1">{phone.model}</span></p>
          <p className="text-gray-300 text-sm z-10 relative">Stock: <span className="font-semibold text-white">{phone.stock}</span></p>
          ...
          <p className="text-gray-300 text-sm z-10 relative flex items-center"><FaBatteryFull className="mr-2 text-green-400" /> Battery: <span className="font-semibold text-green-400 ml-1">{phone.battery} mAh</span></p>
          <p className="text-gray-300 text-sm z-10 relative">Camera: <span className="font-semibold text-white">{phone.camera}</span></p>
